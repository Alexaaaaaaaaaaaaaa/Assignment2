...
function Main(){
  const M=_c_10.EmbedView(Map((endpoint) => endpoint.$==1?PortfolioPage():Main_1(), currentPage().View));
  const U=Router_1_LinkHash(router(), {$:0});
  const this_1=new _c_1("New_1");
  const this_2=(this_1.h.push(new _c_7("url_home", U)),this_1);
  const builder=(this_2.h.push(new _c_6("maincontainer", M)),this_2);
...
function PortfolioPage(){
  const b=new _c_1("New_1");
  const p=CompleteHoles(b.k, b.h, []);
  const i=new _c_5(p[1], stock(p[0]));
  let _1=(b.i=i,i);
  return _1.Doc;
}
function Main_1(){
  const money=_c_9.Create_1("");
  const B=money.View;
  const t=new _c_1("New_1");
  const this_1=(t.h.push(EventQ2(t.k, "onsend", () => t.i, (e) => {
    const rent=_c_2.Value(e.Vars.Hole("rent")).Get();
    money.Set(prettyPrint(_c_2.Value(e.Vars.Hole("income")).Get()-(rent+_c_2.Value(e.Vars.Hole("utilities")).Get()+_c_2.Value(e.Vars.Hole("vehicle")).Get()+_c_2.Value(e.Vars.Hole("groceries")).Get()+_c_2.Value(e.Vars.Hole("toiletries")).Get()+_c_2.Value(e.Vars.Hole("internet")).Get()+_c_2.Value(e.Vars.Hole("cable")).Get()+_c_2.Value(e.Vars.Hole("phone")).Get()+_c_2.Value(e.Vars.Hole("debt")).Get()+_c_2.Value(e.Vars.Hole("membership")).Get()+_c_2.Value(e.Vars.Hole("health")).Get()+_c_2.Value(e.Vars.Hole("travel")).Get()+_c_2.Value(e.Vars.Hole("other")).Get())));
  })),t);
  const b=(this_1.h.push(new _c_12("balance", B)),this_1);
  const p=CompleteHoles(b.k, b.h, [["rent", 1, null], ["income", 1, null], ["utilities", 1, null], ["vehicle", 1, null], ["groceries", 1, null], ["toiletries", 1, null], ["internet", 1, null], ["cable", 1, null], ["phone", 1, null], ["debt", 1, null], ["membership", 1, null], ["health", 1, null], ["travel", 1, null], ["other", 1, null]]);
  const i=new _c_5(p[1], main(p[0]));
  let _1=(b.i=i,i);
  return _1.Doc;
}
...
function stock(h){
  ...
  return h?NamedTemplate("index", Some("stock"), h):void 0;
}
function main(h){
  LoadLocalTemplates("index");
...
function Router_EndPoint(){
  return JSUnion(void 0, [[null, [[null, []]], []], [null, [[null, ["portfolios"]]], []]]);
}
let _c_9=Lazy((_i) => class Var extends _c {
  static {
    _c_9=_i(this);
  }
  static Create_1(v){
    return new _c_11(false, {s:Ready(v, [])}, v);
  }
  static { }
});
  ...
  return[append(filledHoles, choose((_1) => {
    ...
    if(filledVars.Contains(name))return null;
      ...
      const r=ty===0?_c_16.GetOrAddHoleFor(key, name, () => {
        ...
        let _2=_c_9.Create_1(o==null?"":o.$0);
        return new _c_17(name, _2);
      }):ty===1?_c_16.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_9.Create_1(o==null?0:o.$0);
        return new _c_18(name, _2);
      }):ty===2?_c_16.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_9.Create_1(o==null?false:o.$0);
        return new _c_19(name, _2);
      }):ty===3?_c_16.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_9.Create_1(o==null?-8640000000000000:o.$0);
        return new _c_20(name, _2);
      }):ty===4?_c_16.GetOrAddHoleFor(key, name, () => new _c_21(name, _c_9.Create_1([]))):ty===5?_c_16.GetOrAddHoleFor(key, name, () => new _c_22(name, _c_9.Create_1(Some(globalThis.document.querySelector("[ws-dom="+name+"]"))))):ty===6?_c_16.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_9.Create_1(o==null?[]:o.$0);
...
function prettyPrint(o){
  if(o===null)return"null";
    ...
    if(t=="string")return"\""+o+"\"";
      ...
      if(o instanceof Array)return"[|"+concat_1("; ", map(prettyPrint, o))+"|]";
      else {
        const s=String(o);
        return s=="[object Object]"?"{"+concat_1("; ", map((_1) => _1[0]+" = "+prettyPrint(_1[1]), GetFields(o)))+"}":s;
      }
    }
...
function ofSeq(xs){
  ...
  else if(xs instanceof _c_27)return ofList(xs);
  else {
    const q=[];
    const o=Get(xs);
    try {
...
let _c_14=Lazy((_i) => class Dictionary extends _c {
  ...
  get Values(){
    return new _c_40(this);
  }
  RemoveKey(k){
    return this.remove(k);
  }
  get Keys(){
    return new _c_43(this);
  }
  remove(k){
    const h=this.hash(k);
    const d=this.data[h];
...
function ComputeExitAnim(st, cur){
  return Concat_1(map((n) => GetExitAnim(n.Attr), ToArray(Except(cur, Filter((n) => HasExitAnim(n.Attr), st.PreviousNodes)))));
}
function ComputeEnterAnim(st, cur){
  return Concat_1(map((n) => GetEnterAnim(n.Attr), ToArray(Except(st.PreviousNodes, Filter((n) => HasEnterAnim(n.Attr), cur)))));
}
function ComputeChangeAnim(st, cur){
  const a=(n) => HasChangeAnim(n.Attr);
  const relevant=(a_1) => Filter(a, a_1);
  return Concat_1(map((n) => GetChangeAnim(n.Attr), ToArray(Intersect(relevant(st.PreviousNodes), relevant(cur)))));
}
...
function mapi(f, s){
  return map2_1(f, initInfinite((x) => x), s);
}
function head(s){
  const e=Get(s);
  try {
...
function map2_1(f, s1, s2){
  return{GetEnumerator:() => {
    const e1=Get(s1);
    const e2=Get(s2);
    return new _c_26(null, null, (e) => e1.MoveNext()&&e2.MoveNext()&&(e.c=f(e1.Current, e2.Current),true), () => {
      e1.Dispose();
      e2.Dispose();
    });
  }};
...
function unfold(f, s){
  return{GetEnumerator:() => new _c_26(s, null, (e) => {
    const m=f(e.s);
...
let _c_24=Lazy((_i) => class Exception extends _c {
  static {
    _c_24=_i(this);
  }
});
...
function ChildrenTemplate(el, fillWith){
  ...
  return!Equals(m, null)&&m.length===1&&(get(m, 0)instanceof Node&&(Equals(get(m, 0).nodeType, Node.ELEMENT_NODE)&&(_1=get(m, 0),true)))?_c_30.TreeNode(docTreeNode, updates):_c_10.Mk(TreeDoc(docTreeNode), updates);
}
function set_RenderedFullDocTemplate(_1){
  _c_29.RenderedFullDocTemplate=_1;
}
...
function InlineTemplate(el, fillWith){
  ...
  foreachNotPreserved(el, "[ws-on]", (e_1) => {
    addAttr(e_1, _c_36.Concat(choose((x_1) => {
      let o;
      ...
      if(m[0]){
        const th=m[1];
        return th instanceof _c_35?Some(Handler(get(a, 0), th.Value)):th instanceof _c_13?Some(_c_36.Handler(get(a, 0), th.Value)):(console.warn("Event hole on"+get(a, 0)+" filled with non-event data", get(a, 1)),null);
      }
      else return null;
    ...
    for(let i=0, _7=holeAttrs.length-1;i<=_7;i++)((() => {
      ...
      const value=foldBack((_9, _10) =>(((t) => {
        ...
        return(t_1) => {
          ...
          return holeContent.$==1?[textBefore_1, _c_27.Cons(textAfter==""?holeContent.$0:Map((s_5) => s_5+textAfter, holeContent.$0), views)]:[textBefore_1+holeContent.$0+textAfter, views];
        };
      })(_9))(_10), res, [finalText, _c_27.Empty]);
      if(value[1].$==1){
        if(value[1].$1.$==1){
          if(value[1].$1.$1.$==1){
            if(value[1].$1.$1.$1.$==0){
              const s_1=value[0];
              _8=Dynamic_1(attrName, Map3((_9, _10, _11) => s_1+_9+_10+_11, value[1].$0, value[1].$1.$0, value[1].$1.$1.$0));
            }
            else {
              const s_2=value[0];
              _8=Dynamic_1(attrName, Map((vs) => s_2+concat_1("", vs), Sequence(value[1])));
            }
          }
          else {
            const s_3=value[0];
            _8=Dynamic_1(attrName, Map2((_9, _10) => s_3+_9+_10, value[1].$0, value[1].$1.$0));
          }
        }
        else if(value[0]=="")_8=Dynamic_1(attrName, value[1].$0);
        else {
          const s_4=value[0];
          _8=Dynamic_1(attrName, Map((v) => s_4+v, value[1].$0));
        }
      }
      else _8=_c_36.Create(attrName, value[0]);
...
let _c_25=Lazy((_i) => class Route {
  ...
  static FromHash(path, strict){
    ...
    if(m===-1)return _c_25.Empty;
    else {
      const h=path.substring(m+1);
      return strict!=null&&strict.$0?h==""||h=="/"?_c_25.Empty:StartsWith(h, "/")?_c_25.FromUrl(h.substring(1), Some(true)):_c_25.Segment_2(h):_c_25.FromUrl(path.substring(m), Some(false));
    }
  }
  static Combine(paths){
    ...
    if(m===0)return _c_25.Empty;
    else if(m===1)return get(paths_1, 0);
    else {
      method=null;
      body=null;
      const segments=[];
      queryArgs=new _c_31("New", []);
      formData=new _c_31("New", []);
      iter((p) => {
        const m_1=p.Method;
      ...
      return _c_25.New(ofSeq_1(segments), queryArgs, formData, method, body);
    }
  }
  static Segment(s, m){
    return _c_25.New(s, _c_25.Empty.QueryArgs, _c_25.Empty.FormData, m, _c_25.Empty.Body);
  }
  static get Empty(){
    return _c_25.New(_c_27.Empty, new _c_31("New", []), new _c_31("New", []), null, Some(null));
  }
  static FromUrl(path, strict){
    const m=path.indexOf("?");
    const p=m===-1?[path, new _c_31("New", [])]:[Substring(path, 0, m), _c_25.ParseQuery(path.substring(m+1))];
    return _c_25.New(ofArray(SplitChars(p[0], ["/"], strict!=null&&strict.$0?0:1)), p[1], _c_25.Empty.FormData, _c_25.Empty.Method, _c_25.Empty.Body);
  }
  static Segment_2(s){
    return _c_25.New(ofArray([s]), _c_25.Empty.QueryArgs, _c_25.Empty.FormData, _c_25.Empty.Method, _c_25.Empty.Body);
  }
  static ParseQuery(q){
...
function JSUnion(t, cases){
  ...
  const parseCases=ofSeq(collect((_1) => {
    ...
    const a=_1[1];
    const fields=a[2];
    return map_1((_2) =>[i, _2[0], _2[1], fields], a[1]);
  }, indexed(cases)));
  return New((path) => collect((_1) => {
    ...
    if(isCorrectMethod(_1[1], path.Method)){
      ...
      if(m==null)return[];
        ...
        if(m_1.$==0)return[[_c_25.New(p, path.QueryArgs, path.FormData, path.Method, path.Body), createCase(i, [])]];
        else {
          function collect_1(fields){
            return(path_1) =>(acc) => {
              if(fields.$==1){
                const t_1=fields.$1;
                return collect((_2) =>((collect_1(t_1))(_2[0]))(_c_27.Cons(_2[1], acc)), fields.$0.Parse(path_1));
              }
              else return[[path_1, createCase(i, ofList(rev_1(acc)))]];
            };
          }
          return((collect_1(m_1))(_c_25.New(p, path.QueryArgs, path.FormData, path.Method, path.Body)))(_c_27.Empty);
        }
      }
    }
    else return[];
  }, parseCases), (value) => {
    const constIndex=tryFindIndex_1((_1) => {
      const _2=_1[0];
    ...
    const fields=p[2];
    const p_1=get(p[1], 0);
    const casePath=[_c_25.Segment(ofArray(p_1[1]), p_1[0])];
...
function WriteQuery(q){
  return concat_1("&", map_1((_1) => _1[0]+"="+_1[1], ToSeq(q)));
}
...
function ofArray(arr){
  let r=_c_27.Empty;
  for(let i=length(arr)-1, _1=0;i>=_1;i--)r=_c_27.Cons(get(arr, i), r);
  return r;
}
function rev_1(l){
  let res=_c_27.Empty;
...
function ofSeq_1(s){
  if(s instanceof _c_27)return s;
    ...
    try {
      let r;
      let go=e.MoveNext();
      if(!go)return _c_27.Empty;
      else {
        const res=Create_1(_c_27, {$:1});
        r=res;
        while(go)
          {
            r.$0=e.Current;
            if(e.MoveNext()){
              const t=Create_1(_c_27, {$:1});
              r=(r.$1=t,t);
            }
            else go=false;
          }
...
let _c_27=Lazy((_i) => class FSharpList {
  static {
    _c_27=_i(this);
  }
...
function wrapMap(){
  return _c_44.wrapMap;
}
function defaultWrap(){
  return _c_44.defaultWrap;
}
function rxhtmlTag(){
  return _c_44.rxhtmlTag;
}
function rtagName(){
  return _c_44.rtagName;
}
...
let _c_30=Lazy((_i) => {
  ...
  return class Elt extends _c_10 {
    ...
    static TreeNode(tree, updates){
      const rvUpdates=_c_39.Create(updates);
...
function Concat_1(xs){
  return Anim(Concat_2(map_1(List, xs)));
}
function get_Empty(){
  return Anim(Empty_1());
}
function BatchUpdatesEnabled(){
  return _c_41.BatchUpdatesEnabled;
}
...
function ToSeq(m){
  return map_1((kv) =>[kv.Key, kv.Value], Enumerate(false, m.Tree));
}
function OfArray(a){
  return new _c_31("New_1", OfSeq(map_1((_1) => _c_42.New(_1[0], _1[1]), a)));
}
let _c_31=Lazy((_i) => class FSharpMap extends _c {
  static {
    _c_31=_i(this);
  }
  tree;
  Add_1(k, v){
    return new _c_31("New_1", Add(_c_42.New(k, v), this.tree));
  }
  get IsEmpty(){
...
function cancel(c){
  c.k(Cc(new _c_53("New", c.ct)));
}
let _c_32=Lazy((_i) => class $StartupCode_Abbrev {
  static {
    _c_32=_i(this);
  }
  static counter;
...
function Static(attr){
  return _c_36.A3(attr);
}
function Dynamic(view, set_1){
  return _c_36.A1(new _c_47(view, set_1));
}
function EmptyAttr(){
  return _c_48.EmptyAttr;
}
...
function AppendTree(a, b){
  if(a===null)return b;
    ...
    const x=_c_36.A2(a, b);
    SetFlags(x, Flags(a)|Flags(b));
    return x;
  }
}
function GetAnim(dyn, f){
  return Concat_1(map((n) => f(n, dyn.DynElem), dyn.DynNodes));
}
...
function ValueWith(bind, var_1){
  const p=bind(var_1);
  return _c_36.Append(Static(p[0]), DynamicCustom(p[1], p[2]));
}
function DynamicCustom(set_1, view){
  return Dynamic(view, set_1);
}
let _c_36=Lazy((_i) => class Attr {
  static {
    _c_36=_i(this);
  }
  static Handler(event, q){
    return _c_36.HandlerImpl(event, q);
  }
  static Concat(xs){
    const x=ofSeqNonCopying(xs);
    return TreeReduce(EmptyAttr(), _c_36.Append, x);
  }
...
let _c_39=Lazy((_i) => class Updates_1 {
  static {
    _c_39=_i(this);
  }
  c;
...
let _c_40=Lazy((_i) => class ValueCollection extends _c {
  static {
    _c_40=_i(this);
  }
  d;
    ...
    while(true)
      {
        if(t_1==null)return spine.$==1?Some([spine.$0[0], [spine.$0[1], spine.$1]]):null;
          ...
          t_2=t_1;
          t_1=t_2.Right;
          spine=_c_27.Cons([t_2.Node, t_2.Left], spine);
        }
        else {
          t_2=t_1;
          t_1=t_2.Left;
          spine=_c_27.Cons([t_2.Node, t_2.Right], spine);
        }
      }
  }
  return unfold((_1) => gen(_1[0], _1[1]), [t, _c_27.Empty]);
}
function Add(x, t){
...
let _c_42=Lazy((_i) => class Pair {
  ...
  static New(Key, Value_1){
    return Create_1(_c_42, {Key:Key, Value:Value_1});
  }
});
...
let _c_43=Lazy((_i) => class KeyCollection extends _c {
  static {
    _c_43=_i(this);
  }
  d;
...
let _c_44=Lazy((_i) => class $StartupCode_DomUtility {
  static {
    _c_44=_i(this);
  }
  static defaultWrap;
...
let _c_45=Lazy((_i) => class $StartupCode_Animation {
  static {
    _c_45=_i(this);
  }
  ...
  static CubicInOut;
  static {
    this.CubicInOut=_c_49.Custom((t) => {
      const t2=t*t;
      return 3*t2-2*(t2*t);
    });
...
function fromSeq(s){
  const a=ofSeq(map_1((_1) => _c_42.New(_1[0], _1[1]), distinctBy((t) => t[0], rev(s))));
  sortInPlace(a);
  return Build(a, 0, a.length-1);
}
let _c_46=Lazy((_i) => class Scheduler extends _c {
  static {
    _c_46=_i(this);
  }
  idle;
...
let _c_48=Lazy((_i) => class Client {
  static {
    _c_48=_i(this);
  }
...
let _c_49=Lazy((_i) => class Easing extends _c {
  static {
    _c_49=_i(this);
  }
  transformTime;
...
let _c_50=Lazy((_i) => class $StartupCode_Concurrency {
  static {
    _c_50=_i(this);
  }
  static GetCT;
  ...
  static {
    ...
    this.scheduler=new _c_46();
    this.defCTS=[new _c_52()];
    this.Zero=Return();
    this.GetCT=(c) => {
      c.k(Ok(c.ct));
    };
...
function StringSet(){
  return _c_48.StringSet;
}
function StringGet(){
  return _c_48.StringGet;
}
function StringListSet(){
  return _c_48.StringListSet;
}
function StringListGet(){
  return _c_48.StringListGet;
}
function DateTimeSetUnchecked(){
  return _c_48.DateTimeSetUnchecked;
}
function DateTimeGetUnchecked(){
  return _c_48.DateTimeGetUnchecked;
}
...
function FileSetUnchecked(){
  return _c_48.FileSetUnchecked;
}
function FileGetUnchecked(){
  return _c_48.FileGetUnchecked;
}
function IntSetUnchecked(){
  return _c_48.IntSetUnchecked;
}
function IntGetUnchecked(){
  return _c_48.IntGetUnchecked;
}
function IntSetChecked(){
  return _c_48.IntSetChecked;
}
function IntGetChecked(){
  return _c_48.IntGetChecked;
}
function FloatSetUnchecked(){
  return _c_48.FloatSetUnchecked;
}
function FloatGetUnchecked(){
  return _c_48.FloatGetUnchecked;
}
function FloatSetChecked(){
  return _c_48.FloatSetChecked;
}
function FloatGetChecked(){
  return _c_48.FloatGetChecked;
}
function StringApply(){
  return _c_48.StringApply;
}
function FloatApplyUnchecked(){
  return _c_48.FloatApplyUnchecked;
}
function BoolCheckedApply(){
  return _c_48.BoolCheckedApply;
}
function DateTimeApplyUnchecked(){
  return _c_48.DateTimeApplyUnchecked;
}
function FileApplyUnchecked(){
  return _c_48.FileApplyUnchecked;
}
function StringListApply(){
  return _c_48.StringListApply;
}
function isBlank(s){
...
let _c_52=Lazy((_i) => class CancellationTokenSource extends _c {
  static {
    _c_52=_i(this);
  }
  init;
